...
`pgpackage` is a Go-first PostgreSQL schema packaging tool in the spirit of `sqlpackage`, built around a standalone CLI and an XML project file.

The workflow is straightforward:

1. Define the desired schema state in a `.pgpackage` project.
